...
local function applyZombieAnim(character)
    ...
    animate.jump.JumpAnim.AnimationId = "rbxassetid://10921351278"
    animate.fall.FallAnim.AnimationId = "rbxassetid://10921350320"
    animate.climb.ClimbAnim.AnimationId = "rbxassetid://10921343576"
end

-- Khi vào game
if player.Character then
    applyZombieAnim(player.Character)
end

-- Khi respawn
player.CharacterAdded:Connect(applyZombieAnim)", true))() -- 👈 link script tải
	end
})
